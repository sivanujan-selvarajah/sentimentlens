...
@Service
public class SentimentService2 {
    ...
    public void init() throws IOException, MalformedModelException {
        model = Model.newInstance("sentiment-model-0000.params");
        model.load(Paths.get("src/main/resources/model"), "sentiment-model-0000.params"); // Lade das trainierte Modell
    ...
    // Innerer Translator: wie der Text verarbeitet wird
